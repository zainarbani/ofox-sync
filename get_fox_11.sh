...
get_twrp_minimal_manifest() {
  local MIN_MANIFEST="git://github.com/minimal-manifest-twrp/platform_manifest_twrp_aosp.git";
  cd $MANIFEST_DIR;
...
local DIR=$MANIFEST_DIR/device/xiaomi;
   ...
   git clone $URL -b "$FOX_BRANCH" "$test_build_device";
